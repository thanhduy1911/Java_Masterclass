package dev.duyhvt.section_22.JDBCChallenges;
...
public class Main {
    private static String USER_SCHEMA = "USE storefront";
    ...
    private static void setUpSchema(Connection conn) throws SQLException {
        ...
        String createOrderDetails = """
                ...
                CONSTRAINT FK_ORDERID_PK FOREIGN KEY (order_id)
