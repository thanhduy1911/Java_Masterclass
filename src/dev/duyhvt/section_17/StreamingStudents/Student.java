...
public class Student {
    ...
    public void addCourse(Course newCourse, LocalDate enrolledDate) {
        engagementMap.put(newCourse.courseCode(),
                new CourseEngagement(newCourse, enrolledDate, "Enrollment"));
    }
    ...
    public int getMonthsSinceActive(String courseCode) {
        CourseEngagement courseEngagement = engagementMap.get(courseCode);
        return courseEngagement == null ? 0 : courseEngagement.getMonthsSinceActive();
    }
