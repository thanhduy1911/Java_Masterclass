package dev.duyhvt.section_13.NestedClasses;

import dev.duyhvt.section_13.NestedClasses.domain.Employee;
import dev.duyhvt.section_13.NestedClasses.domain.EmployeeComparator;
import dev.duyhvt.section_13.NestedClasses.domain.StoreEmployee;
...
public class RunMethods {
    public static void main(String[] args) {
        List<StoreEmployee> storeEmployees = new ArrayList<>(List.of(
                ...
                new StoreEmployee(10105, "Tom", 2021, "Macys"),
