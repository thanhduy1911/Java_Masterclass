package dev.duyhvt.section_10.LinkedList;
...
//        printItinerary3(placesToVisit);
    ...
    private static void addMoreElements(LinkedList<String> linkedList) {
        ...
        linkedList.addLast("Hobart");
        // Queue methods
        linkedList.offer("Melbourne");
        linkedList.offerFirst("Brisbane");
        linkedList.offerLast("Toowoomba");

        // Stack methods
        linkedList.push("Alice Springs");
    }
    ...
    private static void removeElements(LinkedList<String> list) {
        ...
        String s4 = list.poll(); // removes first element
    ...
    private static void gettingElements(LinkedList<String> list) {
        ...
        // Queue (FIFO) retrieval method
        System.out.println("Element from element(): " + list.element());
        // Stack (LIFO) retrieval methods
